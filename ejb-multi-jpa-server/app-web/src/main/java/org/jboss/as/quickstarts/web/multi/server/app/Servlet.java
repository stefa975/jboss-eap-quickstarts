...
import org.jboss.as.quickstarts.ejb.multi.server.app.AppJpaOne;
import org.jboss.as.quickstarts.ejb.multi.server.app.AppJpaTwo;
...
public class Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            try {
                AppJpaOne proxy = (AppJpaOne) lookup(response, iCtx,
            ...
            try {
                AppJpaTwo proxy = (AppJpaTwo) lookup(response, iCtx,
